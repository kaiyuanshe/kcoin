...
public class FabricConfig {
    ...
    private FabricConfig.OrgInfo clientOrganization;

    private Map<String, FabricConfig.Node> orderers;
    private Map<String, FabricConfig.Node> peers;
    private Map<String, FabricConfig.Node> eventHubs;
    ...
    private Properties getNodeProperties(String type, String name, Map<String, FabricConfig.Node> nodes) throws InvalidArgumentException {
        if (isNullOrEmpty(name)) {
            throw new InvalidArgumentException("Parameter name is null or empty.");
        }

        FabricConfig.Node node = nodes.get(name);
        if (node == null) {
    ...
    private void setNodeProperties(String type, String name, Map<String, FabricConfig.Node> nodes, Properties properties) throws InvalidArgumentException {
        if (isNullOrEmpty(name)) {
            throw new InvalidArgumentException("Parameter name is null or empty.");
        }
        if (properties == null) {
    ...
    private Map<String, FabricConfig.OrgInfo> organizations;

    private static final Log logger = LogFactory.getLog(FabricConfig.class);

    private FabricConfig(JsonObject jsonConfig) throws InvalidArgumentException, NetworkConfigurationException {
    ...
    /**
     * Creates a new FabricConfig instance configured with details supplied in a YAML file.
     *
     * @param configFile The file containing the network configuration
     * @return A new FabricConfig instance
     * @throws InvalidArgumentException
     * @throws IOException
     */
    public static FabricConfig fromYamlFile(File configFile) throws InvalidArgumentException, IOException, NetworkConfigurationException {
        return fromFile(configFile, false);
    }

    /**
     * Creates a new FabricConfig instance configured with details supplied in a JSON file.
     *
     * @param configFile The file containing the network configuration
     * @return A new FabricConfig instance
     * @throws InvalidArgumentException
     * @throws IOException
     */
    public static FabricConfig fromJsonFile(File configFile) throws InvalidArgumentException, IOException, NetworkConfigurationException {
        return fromFile(configFile, true);
    }

    /**
     * Creates a new FabricConfig instance configured with details supplied in YAML format
     *
     * @param configStream A stream opened on a YAML document containing network configuration details
     * @return A new FabricConfig instance
     * @throws InvalidArgumentException
     */
    public static FabricConfig fromYamlStream(InputStream configStream) throws InvalidArgumentException, NetworkConfigurationException {

        logger.trace("FabricConfig.fromYamlStream...");
    ...
    /**
     * Creates a new FabricConfig instance configured with details supplied in JSON format
     *
     * @param configStream A stream opened on a JSON document containing network configuration details
     * @return A new FabricConfig instance
     * @throws InvalidArgumentException
     */
    public static FabricConfig fromJsonStream(InputStream configStream) throws InvalidArgumentException, NetworkConfigurationException {

        logger.trace("FabricConfig.fromJsonStream...");
    ...
    /**
     * Creates a new FabricConfig instance configured with details supplied in a JSON object
     *
     * @param jsonConfig JSON object containing network configuration details
     * @return A new FabricConfig instance
     * @throws InvalidArgumentException
     */
    public static FabricConfig fromJsonObject(JsonObject jsonConfig) throws InvalidArgumentException, NetworkConfigurationException {
        ...
        if (logger.isTraceEnabled()) {
            logger.trace(format("FabricConfig.fromJsonObject: %s", jsonConfig.toString()));
        }

        return FabricConfig.load(jsonConfig);
    }

    // Loads a FabricConfig object from a Json or Yaml file
    private static FabricConfig fromFile(File configFile, boolean isJson) throws InvalidArgumentException, IOException, NetworkConfigurationException {
        ...
        if (logger.isTraceEnabled()) {
            logger.trace(format("FabricConfig.fromFile: %s  isJson = %b", configFile.getAbsolutePath(), isJson));
        }
    ...
    /**
     * Returns a new FabricConfig instance and populates it from the specified JSON object
     *
     * @param jsonConfig The JSON object containing the config details
     * @return A populated FabricConfig instance
     * @throws InvalidArgumentException
     */
    private static FabricConfig load(JsonObject jsonConfig) throws InvalidArgumentException, NetworkConfigurationException {
        ...
        return new FabricConfig(jsonConfig);
    }

    public FabricConfig.OrgInfo getClientOrganization() {
        return clientOrganization;
    }

    public FabricConfig.OrgInfo getOrganizationInfo(String orgName) {
        return organizations.get(orgName);
    }

    public Collection<FabricConfig.OrgInfo> getOrganizationInfos() {
     ...
     */
    public FabricConfig.UserInfo getPeerAdmin() throws NetworkConfigurationException {
     ...
     * @throws NetworkConfigurationException
     */
    public FabricConfig.UserInfo getPeerAdmin(String orgName) throws NetworkConfigurationException {

        FabricConfig.OrgInfo org = getOrganizationInfo(orgName);
        if (org == null) {
    ...
    Channel loadChannel(HFClient client, String channelName) throws NetworkConfigurationException {
        ...
        if (logger.isTraceEnabled()) {
            logger.trace(format("FabricConfig.loadChannel: %s", channelName));
        }
    ...
    private void createAllPeers() throws NetworkConfigurationException {
        ...
        if (jsonPeers != null) {
            ...
            for (Entry<String, JsonValue> entry : jsonPeers.entrySet()) {
                ...
                FabricConfig.Node eventHub = createNode(peerName, jsonPeer, "eventUrl"); // may not be present
                if (null != eventHub) {
    ...
    private void createAllOrganizations(Map<String, JsonObject> foundCertificateAuthorities) throws NetworkConfigurationException {
        ...
        if (jsonOrganizations != null) {
            ...
            for (Entry<String, JsonValue> entry : jsonOrganizations.entrySet()) {
                ...
                FabricConfig.OrgInfo org = createOrg(orgName, jsonOrg, foundCertificateAuthorities);
        ...
        try {
            ...
            if (jsonPeers != null) {
                ...
                for (Entry<String, JsonValue> entry : jsonPeers.entrySet()) {
                    ...
                    if (logger.isTraceEnabled()) {
                        logger.trace(format("FabricConfig.reconstructChannel: Processing peer %s", peerName));
                    }
                    ...
                    if (eventHub != null) {
                        ...
                        if (peerOptions.getPeerRoles().size() == PeerRole.ALL.size()) { // means no roles were found but there is an event hub so define all roles but eventing.
    ...
    private Orderer getOrderer(HFClient client, String ordererName) throws InvalidArgumentException {
        ...
        FabricConfig.Node o = orderers.get(ordererName);
        if (o != null) {
    ...
    private FabricConfig.Node createNode(String nodeName, JsonObject jsonNode, String urlPropName) throws NetworkConfigurationException {
...
//        }
        ...
        return new FabricConfig.Node(nodeName, url, props);
    }
    ...
    private FabricConfig.OrgInfo createOrg(String orgName, JsonObject jsonOrg, Map<String, JsonObject> foundCertificateAuthorities) throws NetworkConfigurationException {

        String msgPrefix = format("Organization %s", orgName);

        String mspId = getJsonValueAsString(jsonOrg.get("mspid"));

        FabricConfig.OrgInfo org = new FabricConfig.OrgInfo(orgName, mspId);
        ...
        if (!isNullOrEmpty(adminPrivateKeyString) && !isNullOrEmpty(signedCert)) {
            ...
            org.peerAdmin = new FabricConfig.UserInfo(mspId, "PeerAdmin_" + mspId + "_" + orgName, null);
    ...
    private FabricConfig.CAInfo createCA(String name, JsonObject jsonCA, FabricConfig.OrgInfo org) throws NetworkConfigurationException {
        ...
        List<FabricConfig.UserInfo> regUsers = new LinkedList<>();
        if (registrars != null) {
            ...
            for (JsonObject reg : registrars) {
                ...
                regUsers.add(new FabricConfig.UserInfo(org.mspId, enrollId, enrollSecret));
            }
        }

        FabricConfig.CAInfo caInfo = new FabricConfig.CAInfo(name, org.mspId, url, regUsers, httpOptions);
    ...
    private Peer getPeer(HFClient client, String peerName) throws InvalidArgumentException {
        Peer peer = null;
        FabricConfig.Node p = peers.get(peerName);
        if (p != null) {
    ...
    private EventHub getEventHub(HFClient client, String name) throws InvalidArgumentException {
        EventHub ehub = null;
        FabricConfig.Node e = eventHubs.get(name);
        if (e != null) {
    ...
    public static class OrgInfo {
        ...
        private final List<FabricConfig.CAInfo> certificateAuthorities = new ArrayList<>();
        private FabricConfig.UserInfo peerAdmin;
        ...
        private void addCertificateAuthority(FabricConfig.CAInfo ca) {
        ...
        public List<FabricConfig.CAInfo> getCertificateAuthorities() {
         ...
         * @return The admin user details
         */
        public FabricConfig.UserInfo getPeerAdmin() {
    ...
    public static class CAInfo {
        ...
        private final List<FabricConfig.UserInfo> registrars;

        CAInfo(String name, String mspid, String url, List<FabricConfig.UserInfo> registrars, Properties httpOptions) {
            this.name = name;
            this.url = url;
        ...
        public Collection<FabricConfig.UserInfo> getRegistrars() {
